...
import type { MDDMEnvelope, MDDMBlock } from "../shared/adapter";
...
// makeRegistry's Record uses exactly these keys â€” adding a type here without
...
export async function mddmToDocx(
  ...
  // is absent â€” fall back to returning the blob directly since Packer.toBlob
