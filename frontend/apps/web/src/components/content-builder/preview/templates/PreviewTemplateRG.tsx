...
const SECTION_ORDER = ["evento", "conteudo", "encerramento"];
const SECTION_LABELS: Record<string, string> = {
  evento: "Evento",
  conteudo: "Conteudo do Registro",
  encerramento: "Encerramento",
};

export function PreviewTemplateRG({ sections, content, activeSectionKey }: PreviewTemplateProps) {
