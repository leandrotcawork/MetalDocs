...
const TRANSITION_POLICY: Record<string, { disabledReason?: string; readOnly?: boolean }> = {
  under_review: { disabledReason: 'Documento em revisão — edição bloqueada' },
  superseded: { disabledReason: 'Versão substituída — somente leitura', readOnly: true },
  rejected: { disabledReason: 'Documento rejeitado — edite e submeta novamente' },
  obsolete: { disabledReason: 'Documento obsoleto — somente leitura', readOnly: true },
  cancelled: { disabledReason: 'Aprovação cancelada', readOnly: true },
};
    ...
    <section className={styles.panel} aria-label="Painel de detalhes de aprovação">
      ...
      <div className={styles.section}>
        ...
        <div className={styles.actions}>
          ...
          {status === 'under_review' && lockedByInstanceId ? (
            <button
              type="button"
