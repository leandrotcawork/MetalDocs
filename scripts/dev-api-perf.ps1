...
Write-Host "[dev-api-perf] Using Docker infra as source of truth:"
...
Write-Host "[dev-api-perf] Perf harness overrides:"
Write-Host "  METALDOCS_AUTH_LEGACY_HEADER_ENABLED=$env:METALDOCS_AUTH_LEGACY_HEADER_ENABLED"
Write-Host "  METALDOCS_AUTH_ORIGIN_PROTECTION_ENABLED=$env:METALDOCS_AUTH_ORIGIN_PROTECTION_ENABLED"
Write-Host "[dev-api-perf] Starting local API on port $appPort ..."
